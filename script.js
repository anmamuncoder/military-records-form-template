...
function addRow(type) {
  ...
  if (type === "addresses") {
    ...
    row.innerHTML = `<td>${createSelect(
      ...
      <td>${createInput("text", "gpa", "GPA", false)}</td>
    ...
    row.innerHTML = `<td>${createInput("date", "date_from", "", true)}</td>
      <td>${createInput("date", "date_to", "", true)}</td>
      <td>${createSelect(
        "appointment_type",
...
function validateRequiredSections() {
  ...
  // Validate Passports
  errors.push(
    ...validateTableRequiredFields("passports", ["passport_number"], "Passport")
  );
  ...
  errors.push(
    ...validateTableRequiredFields(
      "service_records",
      ["date_from", "date_to", "appointment_type", "appointment_name"],
      "Service Record"
    )
  );
  ...
  errors.push(
    ...validateTableRequiredFields(
      "overseas_visits",
      ["person", "visit_type", "country", "start_date", "end_date", "reason"],
      "Overseas Visit"
    )
  );
